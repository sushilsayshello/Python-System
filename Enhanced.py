...
st.title("Comprehensive Network Flow Simulation with Real-Time DDoS Attack Alerts")
...
if uploaded_file is not None:
    ...
    X = filtered_data.select_dtypes(include=['number']).drop(columns=['label'], errors='ignore')
